...
do
 {
     ...
     {
        '1' {
            .\EvilCorp-NewMailContact.ps1
        } '2' {
            .\EvilCorp-Enable-o365Mailbox.ps1
        } '3' {
            .\EvilCorp-Check-SkypeSettings.ps1
        } '4' {
            .\EvilCorp-Enable-Skypeo365.ps1
        } '5' {
            .\EvilCorp-Enable-o365MultiGeo.ps1
        } '6' {
            .\EvilCorp-SharedMailboxPermissions.ps1
        } '7' {
            .\EvilCorp-MainMenu.ps1
        } '8' {
            .\EvilCorp-MainMenu.ps1
        } '9' {
...
{
    param (
        [string]$Title = 'EvilCorp Main Script'
    )
    Clear-Host
    Write-Host "================ $Title ================"
    Write-Host ""
...
Function Deploy-Script {
    ...
    $LocalPath = 'c:\Scripts\EvilCorp-MainMenu.ps1'
