...
Function SetLimits-FTE {
    ...
    Write-Host "Setting P2 EvilCorp Standard Limits on Mailbox"
}
...
Function SetLimits-LDE {
    ...
    Write-Host "Setting P1 EvilCorp Standard Limits on Mailbox"
}
...
Function Deploy-Script {
    ...
    $LocalPath = 'c:\Scripts\EvilCorp-Enable-o365Mailbox.ps1'
