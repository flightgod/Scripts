...
$Script:DomainController = "P054ADSAMDC02.amer.EvilCorpCORP.COM"
$Script:UKDomainController = "P054ADSEUDC01.EURO.EvilCorpCORP.COM"
$Script:HKDomainController = "P054ADSAPDC01.APAC.EvilCorpCORP.COM"
...
Function CheckSkypeSettings {
    ...
    $Script:Option = "257"
    $Script:HomeServer = "CN=Lc Services,CN=Microsoft,CN=1:1,CN=Pools,CN=RTC Service,CN=Services,CN=Configuration,DC=EvilCorpCORP,DC=COM"
...
Function Deploy-Script {
    ...
    $LocalPath = 'c:\Scripts\EvilCorp-Check-SkypeSettings.ps1'
