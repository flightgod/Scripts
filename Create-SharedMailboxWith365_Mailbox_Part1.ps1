...
Function checkUser {
 $Script:Continue = ""
    ...
    If ($continue -eq ""){
        ...
        Add-Content c:\temp\DTI_AddIssues_Shared.txt $user
        $continue = ""
    }
    }
}
...
#GetIndivUser
 ...
 # need to check for last name as username might not have been changed yet
    get-aduser $name.Username | select name, DistinguishedName
 }
