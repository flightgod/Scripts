...
$Session = New-PSSession -ConfigurationName Microsoft.Exchange -ConnectionUri http://server.domain.domain.com/PowerShell/ -Authentication Kerberos -Credential $UserCredential
